...
CREATE TABLE IF NOT EXISTS CMS_People (
  ...
  Last_Name varchar(255), -- JS added 'not', DC removed not null
  Date_of_Birth date,
  Gender varchar(50),
  Custom1 varchar(255),
  Custom2 varchar(255),
...
CREATE TABLE IF NOT EXISTS CMS_CaseDetails (
  ...
  Estimated_Settlement_Amount decimal(8,2), --Revised the name from Projected_Settlement_Amount
...
CREATE TABLE IF NOT EXISTS CMS_IntakeDetails (
  ...
  Referral_Fee_Percentage decimal (3,2) , --JS revised from Referral_Fee_ID int
...
CREATE TABLE IF NOT EXISTS CRM_Contacts ( --Revised from CRM_Contact
  ...
  First_Name varchar(255) not null, --added not null
  ...
  Substatus_Name varchar(max), --revised from Substatuses
  Custom1 varchar(255), --JS added
  Custom2 varchar(255), --JS added
  Custom3 varchar(255), --JS added
