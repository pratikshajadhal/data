...
# Optional 11th argument for cluster CloudFormation stack name
...
sh .infra/devops/deploy/local/ecr_build_push.sh $AWS_CLI_PROFILE_NAME $SERVICE_ECR_IMAGE_TAG $ENV_NAME
